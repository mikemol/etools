...
void print_usage(int argc, char* argv[])
{
    const char usage[] =
        ...
        "\n"
        "    -i, --high-thresh=BITS            Number of bits of entropy the "
            "kernel pool"
        "                                      must contain before the "
            "reservoir is fed.\n"
        "\n"
        "    -l, --low-thresh=BITS             Minimum allowed level of "
            "entropy in the\n"
        "                                      kernel pool before bits from "
            "the\n"
        "                                      reservoir are fed into it.\n"
        "\n"
        "    -w, --wait=MICROSECONDS           How long to wait between polls "
            "of the\n"
        "                                      kernel entropy level.\n"
        "\n"
        "    -r, --rand-path=PATH              Path to random device.\n"
        "                                      (Typically /dev/random)\n"
        "\n"
        "    -p, --print-period=MILLISECONDS   How often to print an update "
            "on\n"
        "                                      operational information.\n"
        "\n"
        "    -R, --log-reads                   Print diagnostic information "
            "when we read\n"
        "                                      from the random device.\n"
        "\n"
        "    -W, --log-writes                  Print diagnostic information "
            "when we\n"
        "                                      write to the random device.\n"
        "\n"
        "    -b, --buffer-size=BYTES           Set the size of our internal "
            "entropy \n"
        "                                      buffer.\n"
        "\n"
